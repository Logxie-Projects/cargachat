...
- [ ] **Deep-linking transportador.html** `?viaje_ref=RT-TOTAL-xxx` — parse URL param, scroll + highlight del viaje matching, auto-open modal de oferta si logueado. Requisito para reemplazar el Google Form del mail legacy.
